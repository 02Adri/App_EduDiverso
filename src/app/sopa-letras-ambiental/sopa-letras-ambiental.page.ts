...
@Component({
  selector: 'app-sopa-letras-ambiental',
  templateUrl: './sopa-letras-ambiental.page.html',
  styleUrls: ['./sopa-letras-ambiental.page.scss'],
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar,
  IonButtons, IonButton, IonItem, IonInput,
  IonLabel, IonChip, IonList, IonIcon, IonBackButton, CommonModule, FormsModule]
})
export class SopaLetrasAmbientalPage implements OnInit,OnDestroy {
  ...
  rows = 12;
    ...
    // Palabras clave
    words = [
      'RECICLAJE','ENERGIA','AGUA','FAUNA','ARBOL',
      'PLANETA','AHORRO','LIMPIEZA','AIRE','REUTILIZAR',
    ];
